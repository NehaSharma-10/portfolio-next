    ...
    <div className="max-w-6xl mx-auto">
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8 animate-slide-in-left">
          <div>
            ...
            <div className="space-y-4">
              <Link
                ...
                className="flex items-center space-x-4 p-4 bg-secondary rounded-xl border border-custom hover-lift group"
              >
                ...
                <div>
                  ...
                  <div className="text-primary font-medium group-hover:text-accent transition-colors">shrmatwinkle246@gmail.com</div>
                </div>
              </Link>

              <div className="flex items-center space-x-4 p-4 bg-secondary rounded-xl border border-custom">
                <div className="p-3 bg-accent rounded-lg">
                  <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div>
                  ...
                  <div className="text-primary font-medium">Available for remote work</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-2xl font-bold text-primary mb-6">Connect</h3>
            <div className="flex space-x-4">
              <Link
                href="https://github.com/NehaSharma-10/"
                target="_blank"
                className="p-4 bg-secondary hover:bg-accent rounded-xl transition-all duration-300 hover-lift group border border-custom"
              >
